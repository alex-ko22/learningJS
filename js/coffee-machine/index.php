          ...
          <div class="row coffee-operation p-3">
            <div class="col-6">
              <div class="display p-2">
                <p class="display-text mt-2" id="message">Выберите кофе</p>
                <div class="progress d-none" id="progress-div">
                  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 0%"></div>
                </div>
              </div>
              <div class="coffee-cup mt-2 p-3">
                <img class="d-none" src="" alt="" id="img-bar" >
              </div>
            </div>
            <div class="col-6">
              <div class="coffee-balance">
                <div class="input-group">
                  <input type="text" class="form-control" placeholder="Баланс" value="300">
